...
Theme remain the two amber `«…»` placeholders. **The `.pdf` and `slide-*.jpg` beside it
are NOT regenerated by the script and are still the 11 Sep export — he must re-export the
PDF from PowerPoint** after filling the two portal fields. The .pptx change is in the
